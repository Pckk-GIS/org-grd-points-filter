...
| T03 | 設定モデル作成 | CLI と GUI で共有する設定を定義する | `config.py` | T01 | 複数の領域定義ファイル、入力フォルダ、列番号、出力先を保持できる |
| T04 | 領域定義読み込み | CSV / SHP / GPKG を読み込む | `region_loader.py` | T02, T03 | 複数の領域定義ファイルを複数領域として読み取れる |
